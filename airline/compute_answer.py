...
def compute_answer(
    ...
    extra, info_dict = compute_check_cost(bag_list[1:], direction, routine, customer_class, check_base_tables, override)
...
def compute_overweight(bag: Dict[str, float], routine: str, customer_class: str, complementary: bool):
